...
import { tagRed, tagBlue, tagBlack, highlight } from './Utils';
...
class Deleted extends Component {
    ...
    render() {
        ...
        const renderRef = data => (
            ...
            >
                <View>
                    <Text>{tagBlack(data.item.ref)} {data.item.title}</Text>
                </View>
            </TouchableHighlight>
        );
        ...
        const renderNote = data => (
            ...
            >
                <View>
                    <Text>{tagBlack(data.item.ref)} |{highlight(data.item.author)}| {data.item.text}</Text>
                </View>
            </TouchableHighlight>
        );
            ...
            return (
                <View style={styles.container}>
                    <View style={styles.switchContainer}>
                        <Text style={styles.switchContainer}>Deleted References</Text>
                    </View>
                    <View style={styles.container}>
                        <SwipeListView
                    ...
                    <View style={styles.switchContainer}>
                        <Text style={styles.switchContainer}>Deleted Notes</Text>
                    </View>
                    <View style={styles.container}>
                        <SwipeListView
