...
class Approval extends Component {
    ...
    render() {
        ...
        const renderRef = data => (
            ...
            >
                <View>
                    <Text>{tagOrange(data.item.ref)} {data.item.title}</Text>
                </View>
            </TouchableHighlight>
        );
        ...
        const renderNote = data => (
            ...
            >
                <View>
                    <Text>{tagOrange(data.item.ref)} |{highlight(data.item.author)}| {data.item.text}</Text>
                </View>
            </TouchableHighlight>
        );
            ...
            return (
                <View style={styles.container}>
                    <View style={styles.switchContainer}>
                        <Text style={styles.switchContainer}>References Requiring Approval</Text>
                    </View>
                    <View style={styles.container}>
                        <SwipeListView
                    ...
                    <View style={styles.switchContainer}>
                        <Text style={styles.switchContainer}>Notes Requiring Approval</Text>
                    </View>
                    <View style={styles.container}>
                        <SwipeListView
