...
import { tagRed, tagBlue, tagOrange, highlight, tagGreen } from './Utils';
...
class Recent extends Component {
    ...
    render() {
        ...
        const renderRef = data => (
            ...
            >
                <View>
                    <Text>{tagGreen(data.item.ref)} {data.item.title}</Text>
                </View>
            </TouchableHighlight>
        );
        ...
        const renderNote = data => (
            ...
            >
                <View>
                    <Text>{tagGreen(data.item.ref)} |{highlight(data.item.author)}| {data.item.text}</Text>
                </View>
            </TouchableHighlight>
        );
            ...
            return (
                <View style={styles.container}>
                    <View style={styles.switchContainer}>
                        <Text style={styles.switchContainer}>Recently Modified References</Text>
                    </View>
                    <View style={styles.container}>
                        <SwipeListView
                    ...
                    <View style={styles.switchContainer}>
                        <Text style={styles.switchContainer}>Recently Modified Notes</Text>
                    </View>
                    <View style={styles.container}>
                        <SwipeListView
